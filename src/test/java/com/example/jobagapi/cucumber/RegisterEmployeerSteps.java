...
public class RegisterEmployeerSteps {
    ...
    public void i_sending_employer(Long id) {
        String url=postUrl + "/api" + "/employeers/";
        Employeer newEmployeer = new Employeer(1L,"firstname","lastname",email,number,"password","document","posicion");
    ...
    public void registerARepeatedNumber() {
        String url=postUrl + "/api" + "/employeers/";
        Employeer newEmployeer1 = new Employeer(1L,"firstname","lastname",email,number,"password","document","posicion");
        Employeer employeer1=restTemplate.postForObject(url,newEmployeer1,Employeer.class);
        log.info(employeer1);
